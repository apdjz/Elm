...
var _bob$project$Todo$infoFooter = A2(
...
var _bob$project$Todo$viewControlsCount = function (entriesLeft) {
...
var _bob$project$Todo$onEnter = function (msg) {
...
var _bob$project$Todo$newEntry = F2(
	function (desc, id) {
		return {description: desc, completed: false, editing: false, id: id};
	});
var _bob$project$Todo$emptyModel = {
	entries: {ctor: '[]'},
	visibility: 'All',
	field: '',
	uid: 0
};
var _bob$project$Todo$init = function (savedModel) {
	return A2(
		_elm_lang$core$Platform_Cmd_ops['!'],
		A2(_elm_lang$core$Maybe$withDefault, _bob$project$Todo$emptyModel, savedModel),
		{ctor: '[]'});
};
var _bob$project$Todo$setStorage = _elm_lang$core$Native_Platform.outgoingPort(
	'setStorage',
	function (v) {
		return {
...
var _bob$project$Todo$Model = F4(
	function (a, b, c, d) {
		return {entries: a, field: b, uid: c, visibility: d};
	});
var _bob$project$Todo$Entry = F4(
	function (a, b, c, d) {
		return {description: a, completed: b, editing: c, id: d};
	});
var _bob$project$Todo$ChangeVisibility = function (a) {
	return {ctor: 'ChangeVisibility', _0: a};
};
var _bob$project$Todo$visibilitySwap = F3(
		...
		return A2(
			_elm_lang$html$Html$li,
			{
				...
				_0: _elm_lang$html$Html_Events$onClick(
					_bob$project$Todo$ChangeVisibility(visibility)),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
...
var _bob$project$Todo$viewControlsFilters = function (visibility) {
	return A2(
		...
		{
			ctor: '::',
			_0: A3(_bob$project$Todo$visibilitySwap, '#/', 'All', visibility),
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html$text(' '),
				_1: {
					ctor: '::',
					_0: A3(_bob$project$Todo$visibilitySwap, '#/active', 'Active', visibility),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html$text(' '),
						_1: {
							ctor: '::',
							_0: A3(_bob$project$Todo$visibilitySwap, '#/completed', 'Completed', visibility),
							_1: {ctor: '[]'}
						}
					}
				}
...
var _bob$project$Todo$CheckAll = function (a) {
	return {ctor: 'CheckAll', _0: a};
};
var _bob$project$Todo$Check = F2(
	function (a, b) {
		return {ctor: 'Check', _0: a, _1: b};
	});
var _bob$project$Todo$DeleteComplete = {ctor: 'DeleteComplete'};
var _bob$project$Todo$viewControlsClear = function (entriesCompleted) {
	return A2(
		_elm_lang$html$Html$button,
		{
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onClick(_bob$project$Todo$DeleteComplete),
					_1: {ctor: '[]'}
				}
			}
		},
...
var _bob$project$Todo$viewControls = F2(
	function (visibility, entries) {
		...
		return A2(
			...
			{
				ctor: '::',
				_0: A2(_elm_lang$html$Html_Lazy$lazy, _bob$project$Todo$viewControlsCount, entriesLeft),
				_1: {
					ctor: '::',
					_0: A2(_elm_lang$html$Html_Lazy$lazy, _bob$project$Todo$viewControlsFilters, visibility),
					_1: {
						ctor: '::',
						_0: A2(_elm_lang$html$Html_Lazy$lazy, _bob$project$Todo$viewControlsClear, entriesCompleted),
						_1: {ctor: '[]'}
					}
				}
			});
	});
var _bob$project$Todo$Delete = function (a) {
	return {ctor: 'Delete', _0: a};
};
var _bob$project$Todo$Add = {ctor: 'Add'};
var _bob$project$Todo$UpdateEntry = F2(
	function (a, b) {
		return {ctor: 'UpdateEntry', _0: a, _1: b};
	});
var _bob$project$Todo$EditingEntry = F2(
	function (a, b) {
		return {ctor: 'EditingEntry', _0: a, _1: b};
	});
var _bob$project$Todo$viewEntry = function (todo) {
	return A2(
		_elm_lang$html$Html$li,
		{
			ctor: '::',
							...
							_1: {
								...
								_1: {
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onClick(
											A2(_bob$project$Todo$Check, todo.id, !todo.completed)),
										_1: {ctor: '[]'}
									}
								}
							}
						...
						_0: A2(
							_elm_lang$html$Html$label,
							{
								...
								_0: _elm_lang$html$Html_Events$onDoubleClick(
									A2(_bob$project$Todo$EditingEntry, todo.id, true)),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
							...
							_0: A2(
								_elm_lang$html$Html$button,
								{
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onClick(
											_bob$project$Todo$Delete(todo.id)),
										_1: {ctor: '[]'}
									}
								},
								{ctor: '[]'}),
								...
								_1: {
									...
									_1: {
										...
										_0: _elm_lang$html$Html_Events$onInput(
											_bob$project$Todo$UpdateEntry(todo.id)),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onBlur(
												A2(_bob$project$Todo$EditingEntry, todo.id, false)),
											_1: {
												ctor: '::',
												_0: _bob$project$Todo$onEnter(
													A2(_bob$project$Todo$EditingEntry, todo.id, false)),
												_1: {ctor: '[]'}
											}
										}
...
var _bob$project$Todo$viewKeyedEntry = function (todo) {
	return {
		ctor: '_Tuple2',
		_0: _elm_lang$core$Basics$toString(todo.id),
		_1: A2(_elm_lang$html$Html_Lazy$lazy, _bob$project$Todo$viewEntry, todo)
	};
};
var _bob$project$Todo$viewEntries = F2(
	function (visibility, entries) {
							...
							_1: {
								...
								_1: {
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onClick(
											_bob$project$Todo$CheckAll(!allCompleted)),
										_1: {ctor: '[]'}
									}
								}
							}
				...
				_1: {
					...
					_1: {
						...
						_0: A2(
							...
							A2(
								_elm_lang$core$List$map,
								_bob$project$Todo$viewKeyedEntry,
...
var _bob$project$Todo$UpdateField = function (a) {
	return {ctor: 'UpdateField', _0: a};
};
var _bob$project$Todo$viewInput = function (task) {
	return A2(
							...
							_1: {
								...
								_1: {
									...
									_1: {
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onInput(_bob$project$Todo$UpdateField),
											_1: {
												ctor: '::',
												_0: _bob$project$Todo$onEnter(_bob$project$Todo$Add),
												_1: {ctor: '[]'}
											}
										}
									}
...
var _bob$project$Todo$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: A2(_elm_lang$html$Html_Lazy$lazy, _bob$project$Todo$viewInput, model.field),
					_1: {
						ctor: '::',
						_0: A3(_elm_lang$html$Html_Lazy$lazy2, _bob$project$Todo$viewEntries, model.visibility, model.entries),
						_1: {
							ctor: '::',
							_0: A3(_elm_lang$html$Html_Lazy$lazy2, _bob$project$Todo$viewControls, model.visibility, model.entries),
							_1: {ctor: '[]'}
						}
					}
				}),
			_1: {
				ctor: '::',
				_0: _bob$project$Todo$infoFooter,
				_1: {ctor: '[]'}
			}
		});
};
var _bob$project$Todo$NoOp = {ctor: 'NoOp'};
var _bob$project$Todo$update = F2(
	function (msg, model) {
		var _p1 = msg;
		switch (_p1.ctor) {
			case 'NoOp':
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							...
							entries: _elm_lang$core$String$isEmpty(model.field) ? model.entries : A2(
								...
								{
									ctor: '::',
									_0: A2(_bob$project$Todo$newEntry, model.field, model.uid),
									_1: {ctor: '[]'}
								})
						}),
					{ctor: '[]'});
...
var _bob$project$Todo$updateWithStorage = F2(
	function (msg, model) {
		var _p5 = A2(_bob$project$Todo$update, msg, model);
		var newModel = _p5._0;
		var cmds = _p5._1;
		return {
			ctor: '_Tuple2',
			...
			_1: _elm_lang$core$Platform_Cmd$batch(
				{
					ctor: '::',
					_0: _bob$project$Todo$setStorage(newModel),
					_1: {
						ctor: '::',
						_0: cmds,
						_1: {ctor: '[]'}
...
var _bob$project$Todo$main = _elm_lang$html$Html$programWithFlags(
	{
		init: _bob$project$Todo$init,
		view: _bob$project$Todo$view,
		update: _bob$project$Todo$updateWithStorage,
...
var Elm = {};
Elm['Todo'] = Elm['Todo'] || {};
if (typeof _bob$project$Todo$main !== 'undefined') {
    _bob$project$Todo$main(Elm['Todo'], 'Todo', undefined);
}
